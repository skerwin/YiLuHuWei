...
struct ZYJColor {
    ...
    static let main = colorWithHexString(hex: "#5dbf71")
    ...
    static let tableViewBg = colorWithHexString(hex: "F6FAF9")
    
    static let tableViewLine = colorWithHexString(hex: "DCF1EC")
    struct Line {
