...
//
- (void)menu:(DOPDropDownMenu *)menu confirmBtnClick:(NSMutableDictionary *)indexPathList;


- (void)menu:(DOPDropDownMenu *)menu cancelBtnClick:(NSMutableDictionary *)indexPathList;
