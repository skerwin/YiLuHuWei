...
- (void)drawRect:(CGRect)rect
{
    ...
    //画一条底部线
    CGContextSetRGBStrokeColor(context, 246.0/255, 250.0/255, 249.0/255, 1);//线条颜色
...
- (void)setDataSource:(id<DOPDropDownMenuDataSource>)dataSource {
    ...
    self.layer.backgroundColor = [UIColor colorWithRed:246.0/255 green:250.0/255  blue:249.0/255 alpha: 1].CGColor;
    self.backgroundColor = [UIColor colorWithRed:246.0/255 green:250.0/255  blue:249.0/255 alpha: 1];
    
    for (int i = 0; i < _numOfMenu; i++) {
        //bgLayer colorWithRed:246 green:250 blue:249 alpha: 1
        CGPoint bgLayerPosition = CGPointMake((i+0.5)*bgLayerInterval, self.frame.size.height/2);
        CALayer *bgLayer = [self createBgLayerWithColor:[UIColor colorWithRed:246.0/255 green:250.0/255  blue:249.0/255 alpha: 1] andPosition:bgLayerPosition];
        ...
        CALayer * imageLayer = [CALayer layer];
           //层的  大小
        imageLayer.frame = CGRectMake((i + 1)*separatorLineInterval - separatorLineInterval + 45, self.frame.size.height / 4 + 3, 15, 18);
           //设置委圆角
       ...
       // imageLayer.masksToBounds = YES;
           //加载图片
        if (i == 0){
            imageLayer.contents = (id)[UIImage imageNamed:@"yuntuijian"].CGImage;
        }else{
            imageLayer.frame = CGRectMake((i + 1)*separatorLineInterval - separatorLineInterval + 35, self.frame.size.height / 4 + 3, 15, 18);
            imageLayer.contents = (id)[UIImage imageNamed:@"yunkeshi"].CGImage;
        }
        ...
        //indicator
        CAShapeLayer *indicator = [self createIndicatorWithColor:self.indicatorColor andPosition:CGPointMake((i + 1)*separatorLineInterval - separatorLineInterval/4, self.frame.size.height / 2 + 2)];
...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        //self tapped
        self.backgroundColor = [UIColor colorWithRed:246 green:250 blue:249 alpha: 1];
...
- (CALayer *)createBgLayerWithColor:(UIColor *)color andPosition:(CGPoint)position {
    ...
    layer.backgroundColor = [UIColor colorWithRed:246.0/255 green:250.0/255  blue:249.0/255 alpha: 1].CGColor;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        bg.backgroundColor = [UIColor colorWithRed:246 green:250 blue:249 alpha: 1];
    ...
    if (tableView == _leftTableView) {
        ...
        cell.backgroundColor = [UIColor colorWithRed:246 green:250 blue:249 alpha: 1];
        cell.accessoryView = nil;
    }
